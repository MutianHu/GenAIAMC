...
class DownSample(nn.Module):
    def __init__(self, in_ch):
        super().__init__()
        self.c1 = nn.Conv2d(in_ch, in_ch, (1,3), stride=(1,2), padding=(0,1))
        self.c2 = nn.Conv2d(in_ch, in_ch, (1,5), stride=(1,2), padding=(0,2))
...
class UpSample(nn.Module):
    def __init__(self, in_ch):
        super().__init__()
        self.c = nn.Conv2d(in_ch, in_ch, (1, 3), stride=(1, 1), padding=(0, 1))
        # self.t = nn.ConvTranspose2d(in_ch, in_ch, (1, 5), (0, 2), (0, 2), 1)
        self.t = nn.ConvTranspose2d(in_ch, in_ch, (1, 5), (1, 2), (0, 2), (0, 1))
...
class ResBlock(nn.Module):
    def __init__(self, in_ch, out_ch, tdim, dropout, attn=True):
        ...
        self.block1 = nn.Sequential(
            ...
            Swish(),
            nn.Conv2d(in_ch, out_ch, (1, 3), stride=1, padding=(0, 1)),
        )
        ...
        self.block2 = nn.Sequential(
            ...
            Swish(),
            nn.Dropout(dropout),
            nn.Conv2d(out_ch, out_ch, (1, 3), stride=1, padding=(0, 1)),
        )
        if in_ch != out_ch:
...
class UNet(nn.Module):
    def __init__(self, T, num_labels, ch, ch_mult, num_res_blocks, dropout):
        ...
        self.head = nn.Conv2d(1, ch, kernel_size=(1, 3), stride=1, padding=(0, 1))
        ...
        self.tail = nn.Sequential(
            ...
            Swish(),
            nn.Conv2d(now_ch, 1, kernel_size=(1, 3), stride=1, padding=(0, 1)),
            # nn.BatchNorm2d(1),
            # nn.ReLU(),
        )
